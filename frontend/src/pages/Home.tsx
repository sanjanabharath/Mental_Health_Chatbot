import { MessageCircle, Brain, Heart, Shield, ArrowRight, Sun, Moon, Cloud, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 relative">
        ...
        <div className="text-center animate-fade-in">
          ...
          <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
            Your private AI companion for emotional support, mindfulness, and daily check-ins.
            We're here to listen, support, and guide you on your journey to better mental health.
          </p>
          <Link
            to="/start"
        ...
        {/* How It Works */}
        <div className="mt-32 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            {[
              {
                ...
                description: "Connect with your AI companion in a safe, anonymous space"
              },
              {
                icon: Brain,
                title: "Get Support",
              ...
              },
              {
                ...
                description: "Monitor your emotional well-being and growth over time"
              },
              {
                icon: Shield,
                title: "Stay Connected",
                description: "Regular check-ins and gentle reminders to support your journey"
              }
            ].map((item, index) => (
              <div key={index} className="glass-effect p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
        ...
        {/* Features */}
        <div className="mt-32 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          <div className="glass-effect rounded-2xl p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="flex items-center space-x-3 p-4 rounded-lg bg-white/50 group hover:bg-white/70 transition-colors duration-300">
        ...
        <div className="mt-32 animate-fade-in" style={{ animationDelay: "0.6s" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="glass-effect p-6 rounded-xl shadow-sm">
        ...
        <div className="mt-32 text-center animate-fade-in" style={{ animationDelay: "0.8s" }}>
          <div className="inline-flex items-center space-x-2 glass-effect px-6 py-3 rounded-full">
            ...
            <span className="text-gray-700 font-medium">Your privacy and security are our top priority</span>
          </div>
        </div>
      </div>
    </div>
